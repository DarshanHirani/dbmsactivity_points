<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($db,$_POST['fac-id']);
      $mypassword = mysqli_real_escape_string($db,$_POST['creden']); 
      
      $sql = "SELECT tid FROM teacher WHERE tid = '$myusername' and pass = '$mypassword'";
      ...
      $verify = mysqli_query($db,"SELECT verification_status from teacher where tid='$myusername'");
      ...
      if($count == 1) {
         ...
         $error = "Your Login Name or Password is invalid teacher";
