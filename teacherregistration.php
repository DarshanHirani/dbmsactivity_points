...
if(isset($_POST['submit']))
{
    ...
    $check=mysqli_num_rows(mysqli_query($link,"SELECT * from teacher where tid='$facid'"));


    if($check>0)
    {
      $usnexist="Teacher already registered";
    ...
    //   echo $verification_id;
         ...
         mysqli_query($link,"INSERT into teacher(tname, tid, temail, pass, passcnfm,verification_status,verification_id,proctor) values ('$name','$facid', '$email', '$creden','$credencnmf','0','$verification_id','$proc')");

         $msg="Check your Email to verify the account!"; 
         $mailHTML="Please confirm your account registration by clicking the button or link below:<a href='localhost/checkteacher.php?id=$verification_id'>  localhost/checkteacher.php?id=$verification_id </a>" ;
...
function smtp_mailer($to,$subject,$msg)
{
    ...
    $mail -> IsHTML(true);
    $mail -> CharSet ='UTF-8';
    $mail -> Username ="activitypointsdbms@gmail.com";
    $mail -> Password ="activitypoints@2021";
    $mail -> SetFrom("activitypointsdbms@gmail.com");
        ...
        <div class="container">
            ...
            <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="/loginteacher.html" class="nav-link">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-lead text-white">Use this portal to keep track of the activity points and
                    ...
                    ?>
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        <input autocomplete="off" class="form-control" name="namec"  id="namec" placeholder="Name"
                                            type="text" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            ...
                                            <input class="form-control" placeholder="Faculty ID" type="text" name="fac-id"
                                                id="fac-id" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            ...
                                            <input class="form-control" name="email" placeholder="Faculty Email"
                                                id="email" type="email" oninput="validateEmail(this);" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input class="form-control" placeholder="Password" type="password"
                                                name="creden" id="creden" required>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input class="form-control" placeholder="Confirm Password" type="password"
                                                name="credencnfm" id="credencnfm" required>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input class="form-control" placeholder="Are You A Proctor" type="text"
                                                name="proc" id="proc" required>
                                    ...
                                    <div class="text-muted " id="pass_color"><small>Password strength: <span
                                                id="pass_type" class="font-weight-bold"></span></small></div>
