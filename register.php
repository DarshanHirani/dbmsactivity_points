...
if(isset($_POST['submit']))
{
    ...
    if($check>0)
    {
      ...
      $verification_id=rand(111111111,999999999);
         ...
         $mailHTML="Please confirm your account registration by clicking the button or link below:<a href='localhost/check.php?id=$verification_id'>  localhost/check.php?id=$verification_id </a>" ;
